...
namespace PetFriends.Controllers
{
    public class PadrinhoDoadorController : Controller
    {
        ...
        {
            return View(_context.PadrinhoDoadorModel.ToList());
        }
        ...
        {
            var padrinhoDoador = _context.PadrinhoDoadorModel.Where(PadrinhoDoador => PadrinhoDoador.Id == id).FirstOrDefault();
        ...
        {
            var padrinhoDoador = _context.PadrinhoDoadorModel.Where(PadrinhoDoador => PadrinhoDoador.Id == Model.Id).FirstOrDefault();
        ...
        {
            var padrinhoDoador = _context.PadrinhoDoadorModel.Where(PadrinhoDoador => PadrinhoDoador.Id == id).FirstOrDefault();
            _context.PadrinhoDoadorModel.Remove(padrinhoDoador);
            _context.SaveChanges();
            return RedirectToAction("ListaPadrinhosDoadores");
        }
    }
